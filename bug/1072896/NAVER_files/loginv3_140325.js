...
function getKeyByRuntimeInclude() {
	try {
		...
		keyjs.src = '/loginv3/js/keys_js.nhn';
...
function setIdTextField() {
	var f, d, j, h, l, a, g, o, c, q, e, b, k, p, n, width;
	f = "0";
	d = "0";
	...
	if (typeof useWideLoginboxFlash != "undefined" && useWideLoginboxFlash) {
		j = (width + 20) + "";
	} else {
		j = width + "";
	}
	...
	h = "20";
	l = "25";
	a = "http://img.naver.net/static/common/login/bg_login_id_main_6.gif";
	g = "dotum";
	idBoldTag = "";
	o = "444444";
	c = "12";
...
function setPwTextField() {
	var c, a, b, n, k, r, o, p, j, g, h, l, e, f, d, q, width;
	c = "0";
	a = "25";
	if ((navigator.appVersion.indexOf("MSIE 9") != -1)) {
		width = 101;
	...
	n = "20";
	k = "16";
	r = "http://img.naver.net/static/common/login/bg_login_pw_main_6.gif";
	o = "dotum";
	p = "";
	j = "444444";
	g = "12";
...
function initPage() {
	...
	try {
		...
		if (navigator.userAgent.indexOf("iPad") != -1) {
			document.getElementsByTagName('body').className='t';
		}
	} catch (e) {
	}
	...
	var flashObj = makeFlashObj("http://static.nid.naver.com/loginv3/commonLoginF.swf", "flashlogin", 125, 49, "window", "null", "#f7f7f7", "false");
	var flashArea = $(flasharea);
	flashArea.innerHTML += flashObj;
	checkFlashLoad(1);
}
